...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AlphabeticalListOfProduct>(entity =>
            {
                ...
                entity.ToView("AlphabeticalListOfProducts");
            ...
            modelBuilder.Entity<CategorySalesFor1997>(entity =>
            {
                ...
                entity.ToView("CategorySalesFor1997");
            ...
            modelBuilder.Entity<CurrentProductList>(entity =>
            {
                ...
                entity.ToView("CurrentProductList");
            ...
            modelBuilder.Entity<CustomerAndSuppliersByCity>(entity =>
            {
                ...
                entity.ToView("CustomerAndSuppliersByCity");
            ...
            modelBuilder.Entity<ProductSalesFor1997>(entity =>
            {
                ...
                entity.ToView("ProductSalesFor1997");
            ...
            modelBuilder.Entity<ProductsByCategory>(entity =>
            {
                ...
                entity.ToView("ProductsByCategory");
            ...
            modelBuilder.Entity<SalesTotalsByAmount>(entity =>
            {
                ...
                entity.ToView("SalesTotalsByAmount");
            ...
            modelBuilder.Entity<SummaryOfSalesByQuarter>(entity =>
            {
                ...
                entity.ToView("SummaryOfSalesByQuarter");
            ...
            modelBuilder.Entity<SummaryOfSalesByYear>(entity =>
            {
                ...
                entity.ToView("SummaryOfSalesByYear");
